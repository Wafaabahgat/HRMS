            ...
            <div class="card-body">
                @if (@isset($data) and !@empty($data))
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tr>
                            <td class="width30">حاله التفعيل</td>
                            <td class="width30">
                        ...
                        <tr>
                            ...
                            <td class="width30">{{ $data['phones'] }}</td>
                        </tr>
                        <tr>
                            <td class="width30">البريد الالكتروني للشركة</td>
                            <td class="width30">{{ $data['email'] }}</td>
                        </tr>
                        <tr>
                            <td class="width30">عنوان الشركة</td>
                            <td class="width30">{{ $data['address'] }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="width30">الرصيد الاولي المرحل عند تفعيل الاجازات للموظف مثل نزول عشرة ايام ونص بعد
                                سته شهور للموظف </td>
